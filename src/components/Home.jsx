    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <section className="text-center py-20 px-6">
        ...
        >
          ...
          >
            Write, and debug with AI-assisted coding 
          </motion.p>
          <motion.div
  initial={{ opacity: 0 }}
  animate={{ opacity: 1 }}
...
>
  <motion.button // Change this to motion.button
  ...
  {/* Image below and right-aligned under the button */}
  <div className="flex justify-end mt-8">
    <img
      src="https://media.istockphoto.com/id/1414699113/photo/small-robot-assistant-work-with-graphic-display.jpg?s=612x612&w=0&k=20&c=gGfba4h97L1tFjVWkPTiZUlfNHtkrf0fHhsmkY4S5Ng="
      alt="AI Assistant Robot"
      style={{ width: '240px', height: '240px', borderRadius: '16px', boxShadow: '0 4px 24px rgba(0,0,0,0.3)', marginRight: '200px' }}
    />
  </div>
</motion.div>
      ...
      {/*<img
        src="https://media.istockphoto.com/id/1414699113/photo/small-robot-assistant-work-with-graphic-display.jpg?s=612x612&w=0&k=20&c=gGfba4h97L1tFjVWkPTiZUlfNHtkrf0fHhsmkY4S5Ng="
        alt="AI Assistant Robot"
        style={{ position: 'fixed', bottom: '24px', right: '24px', width: '240px', height: '240px', zIndex: 50, borderRadius: '16px', boxShadow: '0 4px 24px rgba(0,0,0,0.3)' }}
      />*/}
    </div>
  );
}
